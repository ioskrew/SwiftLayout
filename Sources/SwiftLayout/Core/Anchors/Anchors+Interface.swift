...
public extension Anchors {
    ...
    @available(*, deprecated, renamed: "horizontal.equalToSuper(inwardOffset:)")
    ...
    @available(*, deprecated, renamed: "horizontal.equalTo(_:inwardOffset:)")
    ...
    /// - Returns: superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "vertical.equalToSuper(inwardOffset:)")
    ...
    @available(*, deprecated, renamed: "vertical.equalTo(_:inwardOffset:)")
    ...
    @available(*, deprecated, renamed: "allSides.equalToSuper(inwardOffset:)")
    ...
    /// **AND**
    /// superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "allSides.equalTo(_:inwardOffset:)")
    ...
    /// **AND**
    /// superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "cap.equalToSuper(inwardOffset:)")
    ...
    /// **AND**
    /// superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "cap.equalTo(_:inwardOffset:)")
    ...
    /// **AND**
    /// superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "shoe.equalToSuper(inwardOffset:)")
    ...
    /// **AND**
    /// superview.leading + constant(offset) and superview.trailing - constant(offset)
    @available(*, deprecated, renamed: "shoe.equalTo(_:inwardOffset:)")
    ...
    @available(*, deprecated, renamed: "size.equalTo(_:)")
    ...
    @available(*, deprecated, renamed: "size.equalTo(width:height:)")
    ...
    @available(*, deprecated, renamed: "size.equalTo(_:widthOffset:heightOffset:)")
    ...
    @available(*, deprecated, renamed: "center.equalToSuper(xOffset:yOffset:)")
    ...
    @available(*, deprecated, renamed: "center.equalTo(_:xOffset:yOffset:)")
